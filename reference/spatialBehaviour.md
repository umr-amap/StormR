...
- if `product = "Profiles"` the function returns one layer for wind
  ...
  "PAM_Direction_41",...). Wind direction layers indicate where the wind
  is blowing from, measured from 0° (North) clockwise.
...
#> -> Gathering storm(s) ... 
#> 
#> === DONE with run time 0.4743676 sec ===
#> 
#> SUMMARY:
#> (*) LOI: Vanuatu 
#> (*) Buffer size: 300 km
