...
The `getNames()` function returns the names of the storms in a `storm`
or a `stormsList` object.
...
#> 
#> === DONE with run time 0.5209975 sec ===
#> 
#> SUMMARY:
#> (*) LOI: New Caledonia 
#> (*) Buffer size: 300 km
...
getNames(sts)
#> [1] "PAM"    "SOLO"   "ULA"    "UESI"   "GRETEL" "LUCAS"  "NIRAN" 
# }
```
