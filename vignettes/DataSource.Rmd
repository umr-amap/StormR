...
object using the USA fields in the IBTrACS database
...
$^{1}$ Providing the `basin` allows to filter storms in a particular basin 
...
sets can be downloaded [here](https://www.ncei.noaa.gov/data/international-best-track-archive-for-climate-stewardship-ibtracs/v04r00/access/netcdf/). Please, follow the IBTrACS citation recommendations when using these datasets
...
compute wind speed, wind direction, and summary statistics following the international 
system of units (SI) or SI-derived units. Therefore,
...
`defDatabase()` function can be used to convert the data to the desired units.
