...
By default the Saffir-Simpson hurricane wind scale is used in `defStormsList()`
...
RSMC_SCALE = c(16.94, 24.44, 32.5, 43.33, 53.61)
RSMC_PALETTE = c("#6ec1ea","#4dffff","#c0ffc0","#ffd98c","#ff738a","#a188fc")
names(RSMC_PALETTE) = c("Tropical depression",
                         "Tropical storm",
