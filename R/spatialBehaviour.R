...
checkInputsSpatialBehaviour <- function(sts, sds, product, windThreshold, method, asymmetry,
...
#' msw.pam <- spatialBehaviour(pam, sds)
#'
#' # Computing PDI generated by Pam (2015) near Vanuatu using the Holland model without asymmetry
#' pdi.pam <- spatialBehaviour(pam, sds, method = "Holland", product = "PDI", asymmetry = "None")
#'
...
#' exp.pam <- spatialBehaviour(pam, sds, product = "Exposure")
#'
#' # Computing wind speed and direction profiles  generated by Pam (2015) near Vanuatu
#' # using Boose model
#' prof.pam <- spatialBehaviour(pam, sds, product = "Profiles", method = "Boose")
#' }
#' @export
spatialBehaviour <- function(sts,
  ...
  checkInputsSpatialBehaviour(
    sts, sds, product, windThreshold, method, asymmetry,
    empiricalRMW, spaceRes, tempRes, verbose
  )
