...
test_that("Test getRmw function", {
  expect_equal(getRmw(seq(0, 80, 5), -15), c(
...
test_that("Test Willougbhy / Holland / Boose functions", {
  expect_equal(
    ...
    c(
      1.813, 3.905, 6.118, 8.414, 10.772, 13.182, 15.635, 18.127, 20.652, 23.208,
  ...
  expect_equal(
    ...
    c(
      25.621, 31.978, 36.024, 38.946, 41.180, 42.944, 44.365, 45.524, 46.474, 47.257,
  ...
  expect_equal(
    boose(seq(1, 100), 20, 50, 1020 * 100, 915 * 100, 0.1, 0.1, 0.25, 0.25, 15, 1, -15),
    c(
      19.786, 23.774, 26.206, 27.913, 29.192, 30.186, 30.975, 31.611, 32.129, 32.551,
